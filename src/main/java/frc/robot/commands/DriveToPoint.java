...
public class DriveToPoint extends Command {
  ...
  private static final double kXMaxSpeed = 0.425;     // Maximum X velocity (0-1 normalized)
  ...
  private static final double kYMaxSpeed = 0.425;     // Maximum Y velocity (0-1 normalized)
